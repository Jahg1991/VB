...
errHandler:
    ...
    End Sub
        ...
        With Rs
            ...
            .AddNew
                .Fields(1) = Date
                If Text2(0) = -1 Then .Fields(2) = Replace(Text2(0), ",", ".")
                If Text2(1) = -1 Then .Fields(3) = Round(Val(Text2(1)))
                If Text2(2) = -1 Then .Fields(4) = Round(Val(Text2(2)))
                If Text2(3) = -1 Then .Fields(5) = Round(Val(Text2(3)))
                If Text2(4) = -1 Then .Fields(6) = Round(Val(Text2(4)))
                If Text2(5) = -1 Then .Fields(7) = Round(Val(Text2(5)))
                If Text2(6) = -1 Then .Fields(8) = Round(Val(Text2(6)))
                If Text2(7) = -1 Then .Fields(9) = Round(Val(Text2(7)))
                If Text2(8) = -1 Then .Fields(10) = Round(Val(Text2(8)))
                If Text2(9) = -1 Then .Fields(11) = Round(Val(Text2(9)))
                If Text2(10) = -1 Then .Fields(12) = Round(Val(Text2(10)))
                If Text2(11) = -1 Then .Fields(13) = Round(Val(Text2(11)))
                If Text2(12) = -1 Then .Fields(14) = Round(Val(Text2(12)))
                If Text2(13) = -1 Then .Fields(15) = Round(Val(Text2(13)))
