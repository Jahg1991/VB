...
Begin VB.Form frmHistorialCompras 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Command3 
            ...
            Height          =   615
            Left            =   240
            Picture         =   "HistorialCompras.frx":068B
            Style           =   1  'Graphical
            TabIndex        =   14
            Top             =   1080
            Width           =   1455
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Command2 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "HistorialCompras.frx":0E9A
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   2280
            Width           =   1455
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label1 
            BackStyle       =   0  'Transparent
            Caption         =   $"HistorialCompras.frx":16A9
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   12
               Charset         =   0
         ...
         Begin VB.Label Label1 
            BackStyle       =   0  'Transparent
            Caption         =   $"HistorialCompras.frx":1737
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   12
               Charset         =   0
...
errHandler:
        FileNum = FreeFile
        Open App.Path & "\ErrorRegistry.txt" For Append As FileNum
        Print #FileNum, Format(Date, "YYYY-MM-DD") & vbTab & Format(Time, "HH:MM:SS") & vbTab & "Error en: frmHistorialCompras:Command3_Click" & vbTab & err.Number & vbTab & err.Description
        Close FileNum
        err.Clear
...
errHandler:
        FileNum = FreeFile
        Open App.Path & "\ErrorRegistry.txt" For Append As FileNum
        Print #FileNum, Format(Date, "YYYY-MM-DD") & vbTab & Format(Time, "HH:MM:SS") & vbTab & "Error en: frmHistorialCompras:Command1_Click" & vbTab & err.Number & vbTab & err.Description
        Close FileNum
        err.Clear
