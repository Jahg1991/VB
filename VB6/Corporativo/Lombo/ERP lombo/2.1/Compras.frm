                ...
                With Combo1(1)
                    ...
                    Else
                        ...
                        If Rs2.Fields(11).Value = 1 Then
                            Text1(10).Text = "C" & Mid(Date, 9, 2) & Format(Date, "WW", vbMonday) & IdTransaccion
                        Else
                            Text1(10).Text = ""
                        End If
                    End If
    ...
    Private Sub Command2_Click()
        ...
        For i = 0 To List1.ListCount - 1
            ...
            With Rs3
                ...
                .Requery
                .AddNew
                    .Fields(1) = v1     'id clienteproveedor
                    ...
                    .Fields(10) = Replace(Format(Val(v11), "0.00"), ",", ".") 'cantidad
                    .Fields(11) = v12   'UDM
            ...
            If ControlLote = 1 And InLoteExiste = 0 Then
                With Rs7
                    ...
                    .Requery
                    .AddNew
                        .Fields(1) = v8         'idarticulo
                        .Fields(2) = v21        'lote
                        .Fields(3) = "Compras"  'tipo
                    .Update
                    .Requery
                    .Close
                End With
