...
Begin VB.Form frmHistorialVentas 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Label Label1 
            BackStyle       =   0  'Transparent
            Caption         =   $"HistorialVentas.frx":080F
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   12
               Charset         =   0
         ...
         Begin VB.Label Label1 
            BackStyle       =   0  'Transparent
            Caption         =   $"HistorialVentas.frx":089D
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   12
               Charset         =   0
                ...
                If .RecordCount <> 0 Then
                    With TicketComprasVentas
                        ...
                        With .Sections("Sección5")
                            ...
                            .Controls("Label3").Caption = Get_PuntosPorVenta(v2)
                            .Controls("Label4").Caption = Get_ClientePuntos(v1) 'Funcion Puntos
