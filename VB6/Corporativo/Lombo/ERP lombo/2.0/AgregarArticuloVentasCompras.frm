        ...
        For i = 0 To List1.ListCount - 1
                ...
                With Rs4
                    ...
                    If .RecordCount <> 0 Then
                        ...
                        While Not .EOF
                            Rs5.AddNew
                                ...
                                Rs5.Fields(5) = "Consumo de Ingredientes" 'tipo de transaccion
                    ...
                    Else
                        ...
                        Rs5.AddNew
                            ...
                            Rs5.Fields(4) = Date 'fecha
                            Rs5.Fields(5) = "Salida por venta" 'tipo de transaccion
            ...
            If StTipoVentasCompras = "Compras" Then
                With Rs5
                        ...
                        .Fields(4) = Date 'fecha
                        .Fields(5) = "Recepción de compra" 'tipo de transaccion
