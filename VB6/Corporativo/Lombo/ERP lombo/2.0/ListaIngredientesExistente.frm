...
Private Sub Form_Load()
    ...
    With Rs
        ...
        .Open "Select t1.*,t2.descripcion + ' (' + t2.udm + ')' as nombre from ListasDeIngredientes t1, Items t2 where  t1.ItemPTId = t2.id order by 3,6;", Cn, adOpenStatic, adLockOptimistic
        .Requery
    ...
    If Rs.RecordCount > 0 Then
        ...
        With Rs1
            ...
            If .State = 1 Then .Close
            .Open "Select t1.* from items t1 where not exists  (select 1 from ListasDeIngredientes where t1.id = ItemMPId and ItemPTId =" & Rs.Fields(0).Value & ") order by 3;", Cn, adOpenStatic, adLockOptimistic
            .Requery
            Combo1(0).Clear
    ...
    Select Case Index
        ...
        Case 0
            ...
            With Rs1
                ...
                If .State = 0 Then
                    .Open "Select t1.* from items t1 where and not exists (select 1 from ListasDeIngredientes where t1.id = ItemMPId and ItemPTId =" & Rs.Fields(0).Value & ") order by 3;", Cn, adOpenStatic, adLockOptimistic
                End If
