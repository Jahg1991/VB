   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Command1 
            ...
            Index           =   0
            Left            =   240
            Picture         =   "ClientesExistente.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   5880
            Width           =   1455
         ...
         Begin VB.CommandButton Command1 
            ...
            Index           =   1
            Left            =   4448
            Picture         =   "ClientesExistente.frx":07EE
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   5880
            Width           =   1455
         ...
         Begin VB.CommandButton Command1 
            ...
            Index           =   2
            Left            =   8896
            Picture         =   "ClientesExistente.frx":101C
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   5880
            Width           =   1455
         ...
         Begin VB.CommandButton Command1 
            ...
            Index           =   3
            Left            =   13600
            Picture         =   "ClientesExistente.frx":18B8
            Style           =   1  'Graphical
            TabIndex        =   6
            Top             =   5880
            Width           =   1455
    ...
    Private Sub Form_Load()
        ...
        If Rs.RecordCount > 0 Then
            With DataGrid1
                ...
                .Columns(12).Caption = "No. de terjeta"
                .Columns(16).Caption = "Monto del credito"
                .Columns(17).Caption = "Dias de credito"
            End With
        Else
            ...
            Case 0
                With Rs
                    If Text1(0) = "" Then
                        ...
                        .Requery
                    Else
                        .Filter = "nombre like '*" & Text1(0) & "*' or telefono like '*" & Text1(0) & "*' or telefono2 like '*" & Text1(0) & "*' or telefono3 like '*" & Text1(0) & "*' or telefono4 like '*" & Text1(0) & "*' or telefono5 like '*" & Text1(0) & "*' or telefono6 like '*" & Text1(0) & "*' or [Correo electronico] = '" & Text1(0) & "'"
                        .Requery
                    End If
                End With
