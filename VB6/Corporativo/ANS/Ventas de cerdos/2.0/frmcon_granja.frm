...
Begin VB.Form frmcon_granja 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Búsqueda por granja"
   ClientHeight    =   11475
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   17895
   ...
   Begin VB.CommandButton Imprimir 
      Height          =   375
      Left            =   4920
      Picture         =   "frmcon_granja.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   120
      Width           =   495
   ...
   Begin VB.CommandButton Command4 
      Height          =   375
      Left            =   5520
      Picture         =   "frmcon_granja.frx":05AF
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   120
      Width           =   495
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmcon_granja.frx":0BE2
      Height          =   10575
      Left            =   120
      TabIndex        =   7
      Top             =   600
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frmcon_granja.frx":0BF7
      OLEDBString     =   $"frmcon_granja.frx":0C7F
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   End
End
Attribute VB_Name = "frmcon_granja"
...
Adodc1.Recordset.Filter = "GRANJA LIKE '*" & Combo1.Text & "*'"
Else
