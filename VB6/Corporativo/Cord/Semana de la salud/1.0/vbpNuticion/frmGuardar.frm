                ...
                Else
                    With Rs
                        ...
                        .AddNew
                            ...
                            .Fields("Consulta") = Form1.Check1(1)
                            .Fields("Platica") = Form1.Check1(0)
...
Private Sub Form_Load()
    ...
    With Rs
        If .State = 1 Then .Close
            .Open "select * from nuticion", Cn, adOpenDynamic, adLockOptimistic
            .Requery
    End With
    With Dp
        If .State = 1 Then .Close
            If Form1.Label2 <> "" Then
                .Open "select * from nuticion where Id = " & Form1.Label2.Caption & "", Cn, adOpenDynamic, adLockOptimistic
            End If
    End With
