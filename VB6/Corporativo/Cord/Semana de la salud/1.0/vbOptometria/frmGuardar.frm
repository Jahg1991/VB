...
Private Sub Form_Load()
    ...
    With Rs
        If .State = 1 Then .Close
            .Open "select * from optometria", Cn, adOpenDynamic, adLockOptimistic
            .Requery
    End With
    With Dp
        If .State = 1 Then .Close
            If Form1.Label2 <> "" Then
                .Open "select * from optometria where Id =" & Form1.Label2.Caption & "", Cn, adOpenDynamic, adLockOptimistic
            End If
    End With
