...
Begin VB.Form Form2 
   ...
   EndProperty
   Icon            =   "frmBusquedaTrabajador.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2925
   ...
   Begin VB.CommandButton Command1 
      ...
      Index           =   1
      Left            =   4560
      Picture         =   "frmBusquedaTrabajador.frx":324A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2160
      Width           =   1695
   ...
   Begin VB.CommandButton Command1 
      ...
      Index           =   0
      Left            =   2760
      Picture         =   "frmBusquedaTrabajador.frx":3D4B
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   2160
      Width           =   1695
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   120
      Picture         =   "frmBusquedaTrabajador.frx":48B1
      Top             =   120
      Width           =   750
   End
End
...
Private Sub Command1_Click(Index As Integer)
    Select Case Index
        Case 0
            Form1.Enabled = True
            Form1.Text1(0).Text = DataGrid1.Columns(0).Text
            Form1.DTPicker1.SetFocus
            Rs.Filter = ""
            Rs.Close
            Cn.Close
            Unload Form2
...
Private Sub Form_Load()
    ...
    DataGrid1.Columns(0).DataField = "Nombre"
    DataGrid1.Columns(0).Width = 5900
End Sub
