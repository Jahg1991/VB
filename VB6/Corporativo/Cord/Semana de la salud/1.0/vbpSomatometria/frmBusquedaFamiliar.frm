...
Begin VB.Form Form3 
   ...
   EndProperty
   Icon            =   "frmBusquedaFamiliar.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2925
   ...
   Begin VB.CommandButton Command1 
      ...
      Index           =   1
      Left            =   4560
      Picture         =   "frmBusquedaFamiliar.frx":324A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   2040
      Width           =   1695
   ...
   Begin VB.CommandButton Command1 
      ...
      Index           =   0
      Left            =   2760
      Picture         =   "frmBusquedaFamiliar.frx":3D4B
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   2040
      Width           =   1695
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   120
      Picture         =   "frmBusquedaFamiliar.frx":48B1
      Top             =   120
      Width           =   750
   End
End
...
Private Sub Command1_Click(Index As Integer)
    Select Case Index
        Case 0
            Form1.Enabled = True
            Form1.Text1(3).Text = DataGrid1.Columns(0).Text
