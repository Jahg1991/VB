                ...
                Else
                    With Rs
                        ...
                        .AddNew
                            ...
                            .Fields("Colesterol") = Form1.Text1(1)
                            .Fields("Trigliceridos") = Form1.Text1(2)
                            .Fields("Glucosa") = Form1.Text1(3)
                            .Fields("Observaciones") = Form1.Text1(4)
                        .Update
                        .Requery
                    End With
                    Form1.Enabled = True
...
Private Sub Form_Load()
    ...
    With Rs
        If .State = 1 Then .Close
            .Open "select * from laboratorio", Cn, adOpenStatic, adLockOptimistic
            .Requery
    End With
    With Dp
        If .State = 1 Then .Close
            If Form1.Label2 <> "" Then
                .Open "select * from laboratorio where Id =" & Form1.Label2.Caption & "", Cn, adOpenDynamic, adLockOptimistic
            End If
    End With
