                ...
                Else
                    With Rs
                        ...
                        .AddNew
                            ...
                            .Fields("Limpieza") = Form1.Check1(1)
                            .Fields("Revision") = Form1.Check1(0)
...
Private Sub Form_Load()
    ...
    With Rs
        If .State = 1 Then .Close
            .Open "select * from dental", Cn, adOpenDynamic, adLockOptimistic
            .Requery
    End With
    With Dp
        If .State = 1 Then .Close
            If Form1.Label2 <> "" Then
                .Open "select * from dental where Id = " & Form1.Label2.Caption & "", Cn, adOpenDynamic, adLockOptimistic
            End If
    End With
