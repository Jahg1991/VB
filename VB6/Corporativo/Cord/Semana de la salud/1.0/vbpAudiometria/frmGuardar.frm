                ...
                Else
                    With Rs
                        ...
                        .AddNew
                            ...
                            .Fields("LavadoOidos") = Form1.Check1(0)
                            .Fields("PruebaAudicion") = Form1.Check1(1)
                            .Fields("Observacion") = Form1.Text1(1)
                        .Update
                        .Requery
                    End With
                    Form1.Enabled = True
...
Private Sub Form_Load()
    ...
    With Rs
        If .State = 1 Then .Close
            .Open "select * from audiometria", Cn, adOpenStatic, adLockOptimistic
            .Requery
    End With
    With Dp
        If .State = 1 Then .Close
            If Form1.Label2 <> "" Then
                .Open "select * from audiometria where Id =" & Form1.Label2.Caption & "", Cn, adOpenDynamic, adLockOptimistic
            End If
    End With
