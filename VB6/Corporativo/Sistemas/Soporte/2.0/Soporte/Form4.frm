...
Begin VB.Form Form4 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"Form4.frx":730F
      OLEDBString     =   $"Form4.frx":739C
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
...
Private Sub Combo1_Click(Index As Integer)
    ...
    Select Case Index
        Case 0
            DataGrid1.Columns(7).Text = Combo1(0).Text
            Adodc1.Recordset.Update
        Case 1
            DataGrid1.Columns(5).Text = Combo1(1).Text
            Adodc1.Recordset.Update
    End Select
...
Private Sub Form_Load()
    ...
    Combo1(0).AddItem ("Cristian Navarro")
