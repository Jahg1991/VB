...
End Sub
    ...
    Private Sub Form_Load()
        ...
        Me.Caption = "Enviar correo interno a " + Form3.Label2(3).Caption
        Command1.Caption = " Enviar mail "
          
        txt_Servidor.Text = "10.1.1.250"
        txt_Servidor.Visible = False
        txt_Para = Form3.Label2(3).Caption
        txt_De = "soporte@sistemas.org.mx"
        'txt_Asunto = "Prueba"
        'txt_Mensaje = "Hola"
        ...
        txt_Usuario = "soporte@sistemas.org.mx"
