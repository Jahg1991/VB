        ...
        Case 1
            ...
            With RS
                ...
                If .RecordCount <> 0 Then
                    ...
                    Frame1(1).Caption = "Nueva Venta            Folio [RNC-" & .Fields(0).Value & "]"
                End If
            ...
            With Text2(3)
                ...
                If Val(.Text) = 0 Then
                    ...
                    If vbq = vbNo Then
                        Exit Sub
                    'Else
                    '    vbq = MsgBox("¿De verdad no vas a poner descuento?", vbQuestion + vbYesNo, "Advertencia")
                
                    '    If vbq = vbNo Then
                    '        Exit Sub
                    '    Else
                    '        vbq = MsgBox("¿Estas seguro?, piensalo bien", vbQuestion + vbYesNo, "Advertencia")
                
                    '        If vbq = vbNo Then
                    '            Exit Sub
                    '        Else
                    '            vbq = MsgBox("¿es tu ultima oportunidad de poner descuento, desea continuar?", vbQuestion + vbYesNo, "Advertencia")
                
                    '            If vbq = vbNo Then
                    '                Exit Sub
                    '            Else
                    '                MsgBox "Esta bien, despues no te estes quejando", vbOKOnly
                    '            End If
                    '        End If
                    '    End If
                    End If
            ...
            If vLine_number = 1 Then
                With RS
                    ...
                    If .RecordCount <> 0 Then
                        ...
                        vCust_po_number = "RNC-" & .Fields(0).Value
                    End If
