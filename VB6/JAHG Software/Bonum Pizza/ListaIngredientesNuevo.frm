...
Private Sub Form_Load()
    ...
    With Rs1
        ...
        .Open "Select * from items t1 where t1.tipo = '" & StTipoItem & "'  and UDM <> 'Servicio' and not exists  (select 1 from ListasDeIngredientes where t1.id =ItemPTId) order by 3;", Cn, adOpenStatic, adLockOptimistic
        .Filter = ""
        .Requery
    ...
    If Rs1.RecordCount > 0 Then
        ...
        With Rs2
            ...
            If .State = 1 Then .Close
            .Open "Select t1.* from items t1 where t1.tipo = 'Ingredientes Generales' and UDM <> 'Servicio' order by 3;", Cn, adOpenStatic, adLockOptimistic
            .Filter = ""
            .Requery
