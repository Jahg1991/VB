...
Private Sub Form_Load()
    ...
    With Rs
        ...
        If StTipoVentasCompras = "Ventas" Then
            ...
            If StTipoVenta = "Barra Local" Then
                .Open "Select * from CabeceraVentas where tipoArt ='Barra' and LugarVenta = 'Local';", Cn, adOpenStatic, adLockOptimistic
            End If
            
            If StTipoVenta = "Barra Domicilio" Then
                .Open "Select * from CabeceraVentas where tipoArt ='Barra' and LugarVenta = 'Domicilio';", Cn, adOpenStatic, adLockOptimistic
            End If
            
            If StTipoVenta = "Cocina Local" Then
                .Open "Select * from CabeceraVentas where tipoArt ='Cocina' and LugarVenta = 'Local';", Cn, adOpenStatic, adLockOptimistic
            End If
            
            If StTipoVenta = "Cocina Domicilio" Then
                .Open "Select * from CabeceraVentas where tipoArt ='Cocina' and LugarVenta = 'Domicilio';", Cn, adOpenStatic, adLockOptimistic
            End If
            
            If StTipoVenta = "Abiertas" Then
                'JAHG 20200331 PAGO
                '.Open "Select * from CabeceraVentas1 where totalPagado = 0;", Cn, adOpenStatic, adLockOptimistic
                .Open "Select * from CabeceraVentas1 where totalPagado < total;", Cn, adOpenStatic, adLockOptimistic
                'JAHG 20200331 PAGO
            End If
        ...
        If StTipoVentasCompras = "Compras" Then
            ...
            If StTipoCompra = "Pagadas" Then
                ...
                .Open "Select * from CabeceraCompras where totalPagado = total;", Cn, adOpenStatic, adLockOptimistic
                'JAHG 20200331 PAGO
            End If
...
Private Sub List1_Click()
    ...
    If StTipoVentasCompras = "Ventas" Then
        ...
        Else
            ...
            If StTipoVenta = "Barra Local" Or StTipoVenta = "Barra Domicilio" Then
                Rs1.Filter = "Folio = '" & Trim(Mid(List1.Text, 1, 10)) & "' and TipoArticulo = 'Barra'"
            Else
                Rs1.Filter = "Folio = '" & Trim(Mid(List1.Text, 1, 10)) & "' and TipoArticulo = 'Cocina'"
            End If
    ...
    If Mid(List1.Text, 1, 10) <> "" Then
        ...
        If StTipoVentasCompras = "Ventas" Then
            ...
            With Rs6
                ...
                If .State = 1 Then .Close
 '               .Open "Select * from ticket where tipoarticulo ='Barra' and folio = '" & Mid(List1.Text, 1, 10) & "';", Cn, adOpenStatic, adLockOptimistic
...
'                            .Controls("Etiqueta2").Caption = "TICKET DE VENTA BARRA"
                            ...
                            .Controls("Label3").Caption = Get_Mesa(Rs6.Fields(6))  'mesa
                            .Controls("Label4").Caption = Get_Comentario(Rs6.Fields(6)) 'comentarios
                        End With
...
Private Sub Pagar_Click()
    ...
    If Mid(List1.Text, 1, 10) <> "" Then
        ...
        Text2(0) = Replace(Format(Val(Trim(Mid(List1.Text, 68, 12))) - Val(Trim(Mid(List1.Text, 81, 12))), "0.00"), ",", ".")
        ...
        'JAHG 20200331 PAGO
            ...
            With Rs1
                ...
                Do Until .EOF
                    ...
                    TMovimiento = Replace(.Fields(16), ",", ".")
                    TPagado = Replace(.Fields(17), ",", ".")
                    ...
                    If Val(TDebido) > 0 Then
                        ...
                        Else
                            ...
                            .Fields(17) = Val(TPagado) + DineroRestante
